...
[<assembly: AssemblyTitleAttribute("Homeworks.Tests")>]
[<assembly: AssemblyProductAttribute("Homeworks")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "Homeworks.Tests"
    let [<Literal>] AssemblyProduct = "Homeworks"
